...
series: [{
    name: '2023',
    type: 'line',
    data: [125,125,123,120,null,null,null,null,null,null,null,null]
}, {
    name: '2022',
    type: 'line',
...
series: [{
    name: 'Intake',
    type: 'column',
    data: [1600, 1880, 1652, 2068,1763, 1963, 2145]
}, {
    name: 'Burn',
    type: 'column',
        ...
        if (component === "panel") {
            ...
            return (
              <div>
                ...
                <div style={{padding: 20}}>
                  ...
                  <p className={styles.fontreg}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            ...
            <div className={styles.overviewcontainer}>
              ...
              <div>
                  ...
                  <StatusCardBlue title="Net Carbs" total= "6/31g" remaining="25g left"/>
                  </div>
                  <div style={{padding:15}}>
                  <StatusCardGreen title="Proteins" total= "78/156g" remaining="78g left"/>
                  </div>
                  <div style={{padding:15}}>
                  <StatusCardRed title="Fat" total= "42/156g" remaining="114g left"/>
                  </div>
              </div>
            </div>
